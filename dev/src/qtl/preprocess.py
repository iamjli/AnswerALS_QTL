...
from src import logger, aals
from src.regions import Regions
from src.qtl.normalize import *
...
def PEER_cmd(PEER_exec_path, phenotype_file, covariates_file, num_peer, output_prefix, output_dir):
	...
	""" 
	cmd = (
		f"time Rscript {PEER_exec_path} {phenotype_file} {output_prefix} {num_peer} -o {output_dir} --covariates {covariates_file}"
	)
	return cmd
